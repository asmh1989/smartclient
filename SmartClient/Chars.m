...
- (unsigned short)Get:(unsigned short)curChar GL:(enum CharsSets)GL GR:(enum CharsSets)GR
{
    ...
    if (curChar < 128)
    {
        ...
        {
            case CharsSet_ASCII:
                [curSet addObjectsFromArray:ASCII];
                break;
                
            case CharsSet_DECSG:
                [curSet addObjectsFromArray:DECSG];
                break;
                
            case CharsSet_NRCUK:
                [curSet addObjectsFromArray:NRCUK];
                break;
                
            case CharsSet_NRCFinnish:
                [curSet addObjectsFromArray:NRCFinnish];
                break;
                
            case CharsSet_NRCFrench:
                [curSet addObjectsFromArray:NRCFrench];
                break;
                
            case CharsSet_NRCFrenchCanadian:
                [curSet addObjectsFromArray:NRCFrenchCanadian];
                break;
                
            case CharsSet_NRCGerman:
                [curSet addObjectsFromArray:NRCGerman];
                break;
                
            case CharsSet_NRCItalian:
                [curSet addObjectsFromArray:NRCItalian];
                break;
                
            case CharsSet_NRCNorDanish:
                [curSet addObjectsFromArray:NRCNorDanish];
                break;
                
            case CharsSet_NRCPortuguese:
                [curSet addObjectsFromArray:NRCPortuguese];
                break;
                
            case CharsSet_NRCSpanish:
                [curSet addObjectsFromArray:NRCSpanish];
                break;
                
            case CharsSet_NRCSwedish:
                [curSet addObjectsFromArray:NRCSwedish];
                break;
                
            case CharsSet_NRCSwiss:
                [curSet addObjectsFromArray:NRCSwiss];
                break;
    ...
    else
    {
        switch (GR)
        {
            case CharsSet_ISOLatin1S:
                [curSet addObjectsFromArray:ISOLAtin1S];
                break;
                
            case CharsSet_DECS:
                [curSet addObjectsFromArray:DECS];
                break;
